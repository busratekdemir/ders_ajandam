                    ...
                    child: ActionBox(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => TopicTrackingPage(studentName: name),
                          ),
                        );
                      },
                    ),
          ...
          if (isLoading)
            ...
            ListView(
              ...
              children: [
                ...
                const SectionTitle(title: 'LGS Matematik konuları'),
                const SizedBox(height: 10),
...
class _TopicTrackingPageState extends State<TopicTrackingPage> {
  ...
  double get progress {
    final completed = topics.where((topic) => topic['done'] == true).length;
    return completed / topics.length;
  }

  int get completedCount {
    return topics.where((topic) => topic['done'] == true).length;
  }
              ...
              ...topics.asMap().entries.map(
                (entry) {
                  ...
                  return TopicCard(
                    ...
                    formula: topic['formula'] as String,
                    isDone: topic['done'] as bool,
                    color: topic['color'] as Color,
                    onTap: () {
                      setState(() {
                        topics[index]['done'] = !(topics[index]['done'] as bool);
                      });
                    },
                  );
                },
